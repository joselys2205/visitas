            ...
            <div class="row">
                <form action="#" method="POST" class="col s12">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            <input type="Date" name="fecha" id="first_name" class="validate" value="<?php echo date("Y-m-d");?>">
                            <label for="confirmfield" class="active">Fecha</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s6">
                            <input type="time" name="hora" value="12:00:00" max="24:00:00" min="00:00:00" step="1" id="first_name" class="validate">
                    ...
                    <form action="#" method="POST" class="col s12">
                        ...
                        <div class="row">
                            <div class="input-field col s6">
                                ...
                                <label for="confirmfield">Hora Sálida: <?php echo $consulta['hor_sal'];?> </label>
                            </div>
                            <div class="input-field col s6">
        ...
        <div class="modal-content">
            ...
            <div class="row">
                <form action="#" method="POST" class="col s12">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            <input type="Date" name="fecham" id="first_name" class="validate" value="<?php echo $consulta['fec_visi'];?>">
                            <label for="confirmfield" class="active">Fecha</label>
                        </div>
                        <div class="input-field col s6">
                            <input type="time" name="horam" value="12:00:00" max="24:00:00" min="00:00:00" step="1" id="first_name" class="validate" value="<?php echo $consulta['hora_visi'];?>">
                            <label for="confirmfield" class="active">Hora Entrada</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s6">
                            <input type="time" name="hora1" value="12:00:00" max="24:00:00" min="00:00:00" step="1" id="first_name" class="validate" value="<?php echo $consulta['hor_sal'];?>">
    ...
    <div id="eliminar<?php echo $consulta['id_visi']; ?>" class="modal">
        <div class="modal-content">
                ...
                <div class="row">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            <input type="Date" name="fechae" id="first_name" class="validate" value="<?php echo $consulta['fec_visi'];?>">
                            <label for="confirmfield" class="active">Fecha</label>
                        </div>
                        <div class="input-field col s6">
                            <input type="time" name="horae" value="12:00:00" max="24:00:00" min="00:00:00" step="1" id="first_name" class="validate" value="<?php echo $consulta['hor_visi'];?>">
                            <label for="confirmfield" class="active">Hora Entrada</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col s6">
                            <input type="time" name="hora1e" value="12:00:00" max="24:00:00" min="00:00:00" step="1" id="first_name" class="validate" value="<?php echo $consulta['hor_sal'];?>">
                            <label for="textfield" class="active">Hora Sálida</label>
                        </div>
                        <div class="input-field col s6">
