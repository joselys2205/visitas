				...
				<div class="col s8 offset-s2 card-panel hoverable">
					<div class="row">
						<div class="col s10 offset-s1">
							<h4 class="center-align">Usuario Inhabilitado</h4>
							<h5 class="center-align">Consulte al Administrador</h5>
							<a href="index.php" class="right color-antv-1 waves-effect waves-light btn">Volver</a>
						</div>
					</div>
				</div>
			</div>
